...
table.ls{{border-collapse:collapse;font-family:'Barlow Condensed',sans-serif;font-size:12px;white-space:nowrap}}
table.ls th{{text-align:center;padding:0 4px;font-weight:700;font-size:10px;color:#888;border-bottom:1px solid #bbb;width:18px}}
